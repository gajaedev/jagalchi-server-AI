...
from ai_core.core.mock_data import COMMENTS
from ai_core.nlp.text_utils import cheap_embed, jaccard_similarity, tokenize
from ai_core.core.types import Comment
