...
- generated_at: 2025-12-23T00:13:30.781022Z
...
```
{
  ...
  "timestamp": "2025-12-23T00:13:30.809017"
}
```
...
const requestInterceptor = (request, ...args) => {
  ...
  if (!["GET", undefined].includes(request.method) && request.credentials === "same-origin") {
    request.headers["X-CSRFTOKEN"] = "lUBYv6b2yt4gcMaoJNCaFnn3ZVDpG1NudRqTXCFOUxxe2LDsXzwxtZqGkReZAyVX";
  }
  return request;
};
...
{
  "meta": {
    "generated_at": "2025-12-23T00:13:40.441355",
    "roadmap_id": "rm_frontend",
    "tech_slug": "react",
    "user_id": "user_1",
    "compose_level": "quick"
  ...
  "record_coach": {
    ...
    "created_at": "2025-12-23T00:13:30.875227",
    "scores": {
      "evidence_level": 3,
      "structure_score": 75,
      "specificity_score": 0,
  ...
  "related_roadmaps": {
    "roadmap_id": "rm_frontend",
    "generated_at": "2025-12-23T00:13:30.875267",
    "candidates": [
      {
  ...
  "tech_fingerprint": {
    "roadmap_id": "rm_frontend",
    "tags": [],
    "generated_at": "2025-12-23T00:13:37.169743",
  ...
  "resource_recommendation": {
    ...
    "generated_at": "2025-12-23T00:13:38.983841",
    "items": [
      {
  ...
  "learning_pattern": {
    ...
    "generated_at": "2025-12-23T00:13:38.983907"
  },
  "graph_rag_context": {
    "retrieval_evidence": [
      {
  ...
  "roadmap_generated": {
    ...
    "created_at": "2025-12-23T00:13:39.003814",
    "retrieval_evidence": [
      {
        "source": "graph",
  ...
  "learning_coach": {
    ...
    "created_at": "2025-12-23T00:13:40.440496",
    "cache_hit": false
  },
  "roadmap_recommendation": {
    ...
    "created_at": "2025-12-23T00:13:40.441350"
  }
}
```
...
```
{
  ...
  "model_version": "rule-based",
  "prompt_version": "record_coach_v1",
  "created_at": "2025-12-23T00:13:40.471001",
  "scores": {
    "evidence_level": 3,
    "structure_score": 75,
    "specificity_score": 0,
...
{
  "roadmap_id": "rm_frontend",
  "generated_at": "2025-12-23T00:13:40.473993",
  "candidates": [
    {
      "related_roadmap_id": "rm_react",
      "score": 1.0,
...
```
{
  "roadmap_id": "rm_frontend",
  "tags": [],
  "generated_at": "2025-12-23T00:13:46.791417",
  "model_version": "tagger_v1"
}
```
...
## resource-recommendation
- method: GET
- url: http://localhost:8000/ai/resource-recommendation?query=React+hooks&top_k=3
- status: 200
- content_type: application/json
- response:
```
{
  "query": "React hooks",
  "generated_at": "2025-12-23T00:13:47.809245",
  "items": [
    {
...
```
{
  ...
  "model_version": "pattern_v1",
  "generated_at": "2025-12-23T00:13:47.813217"
}
```
...
```
{
  ...
  "model_version": "coach_v1",
  "prompt_version": "coach_v1",
  "created_at": "2025-12-23T00:13:49.309803",
  "cache_hit": false
}
```
...
```
{
  ...
  "model_version": "rule-based",
  "prompt_version": "roadmap_gen_v1",
  "created_at": "2025-12-23T00:13:49.337926",
  "retrieval_evidence": [
    {
      "source": "graph",
      "id": "rm_frontend:node_html",
...
```
{
  ...
  "model_version": "roadmap_graph_v1",
  "created_at": "2025-12-23T00:13:49.341817"
}
```
...
```
{
  ...
  "created_at": "2025-12-23T00:13:49.347120"
}
```

## web-search
- method: GET
- url: http://localhost:8000/ai/web-search?query=React+%EA%B3%B5%EC%8B%9D+%EB%AC%B8%EC%84%9C&top_k=2
- status: 200
- content_type: application/json
- response:
```
{
  ...
  "generated_at": "2025-12-23T00:13:50.770199",
  "engines_used": [
    "tavily",
    "exa"
  ],
