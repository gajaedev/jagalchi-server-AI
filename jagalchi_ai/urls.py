...
from jagalchi_ai.ai_core.controller.docs_views import (
    PublicSchemaAPIView,
    RedocUIView,
    SwaggerUIView,
)
...
urlpatterns = [
    # OpenAPI 스키마 및 문서
    path("ai/schema/", PublicSchemaAPIView.as_view(), name="schema"),
    ...
    path(
        "ai/node-resource-recommendation", NodeResourceRecommendationAPIView.as_view()
    ),
