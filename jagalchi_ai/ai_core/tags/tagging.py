...
from jagalchi_ai.ai_core.core.mock_data import TAG_HIERARCHY, TECH_STACKS
from jagalchi_ai.ai_core.nlp.text_utils import cheap_embed, cosine_similarity, tokenize
